...
public class DAO {
	...
	public void getItemPackage(PVO pvo){
		int res = template.insert("itempackage", pvo);
		System.out.println(res);
	}
	
	public List<PVO> getItemPackageList(String id){
		List<PVO> list = template.selectList("itempackagelist", id);
		return list;
	}
}
