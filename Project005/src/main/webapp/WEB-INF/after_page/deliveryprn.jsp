						...
						<td colspan="6">
							<ol class="paging">
								<c:choose>
									...
									<c:otherwise>
										<li><a href="one_p_list=${pvo.beginPage -pvo.pagePerBlock}">이전으로</a></li>
									</c:otherwise>
								</c:choose>
								<c:forEach var="k" begin="${pvo.beginPage}" end="${pvo.endPage}" step="1">
									<c:choose>
										...
										<c:otherwise>
											<li><a href="one_p_list?cPage=${k}">${k}</a></li>
										</c:otherwise>
									</c:choose>
								</c:forEach>
								<c:choose>
									...
									<c:otherwise>
										<li><a href="one_p_list?cPage=${pvo.beginPage + pvo.pagePerBlock}">다음으로</a></li>
									</c:otherwise>
								</c:choose>	
							</ol>
						</td>
